...
prs <- as.data.frame(fread(paste0(FILE,".all_score"), header = T))
...
#If the LID status is coded 1/2 instead of 0/1 uncomment this and modify the header names below accorging to your pheno file 
